    ...
    <div class="relative">
      ...
      <div class="max-w-5xl mx-2 md:mx-auto mt-34 p-6 shadow-lg rounded-[60px] bg-gray-300/10 backdrop-blur-lg">
        <div class="w-full flex flex-col md:flex-row justify-center gap-4 py-8">
          <div class="w-full">
            <h1 class="text-2xl font-bold text-gray-800">AAirtelTigo Big Data</h1>
            <p class=" mt-2 text-white">AirtelTigo Big Data non-expiry data available</p>
          </div>
...
const sizes = ref({
  15: 69, 20: 79, 25: 89, 30: 100, 40: 125, 50: 145, 100: 205, 200: 358
});
