    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div
        ...
        <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
          ...
          <a href="/#"
            class="py-2.5 px-5 h-9 block w-fit bg-yellow-500 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-yellow-700 lg:mx-0">
            Contact us
          </a>
        </div>
        <!--End Col-->
        <div class="lg:mx-auto text-left ">
          <h4 class="text-lg text-gray-900 font-medium mb-7">Bisadatagh</h4>
        ...
        <div class="lg:mx-auto text-left ">
          ...
          <ul class="text-sm  transition-all duration-500">
            <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Data</a></li>
            <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Credit</a></li>
            <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Afa Ragistrations</a></li>
          </ul>
        </div>
        <!--End Col-->
        <div class="lg:mx-auto text-left ">
          ...
          <ul class="text-sm  transition-all duration-500">
            ...
            <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Terms & Conditions</a>
            </li>
      ...
      <div class="py-7 border-t border-gray-200">
        <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
          <span class="text-sm text-gray-500 ">©<a href="/">Bisadatagh</a> 2024, All rights
            reserved.</span>
